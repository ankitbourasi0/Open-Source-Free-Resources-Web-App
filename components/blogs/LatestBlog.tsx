  ...
  return (
    <div className="">
      ...
      <Link href={`/blog/${blog.slug}`}>
        ...
        <div className="group p-3 min-h-[320px] sm:p-4 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
